  ...
  <div class="row justify-content-center">
    <div class="col-md-12">
      <div class="card shadow mb-4">
        <div class="card-header">
          <p class="h5">Data Pendapatan Pemesanan <!-- ( dibayar <span id="d_pmsn1"></span>, belum dibayar <span id="b_pmsn1"></span> , total <span id="t_pmsn1"></span> ) --></p>
        </div>
        <div class="card-body">
          ...
          <div class="card-body">
            ...
            <h1 style="margin-top: 30px; font-size: 20px;">Total Pendapatan Tahun <span id="get-tahun2"></span> = <span id="t_pmsn1" style="font-weight: 700;"></span></h1>
          </div>
          <hr>
          <div class="card-body">
    ...
    <div class="col-md-12">
      <div class="card shadow mb-4">
        ...
        <div class="card-body">
          <table class="table_pmsn text-center" width="100%">
            <thead>
              <tr>
                <th>No.</th>
                <th>Nama Gambar</th>
...
<script type="text/javascript">
  ...
  function totalTahun() {
    ...
    $.ajax({
      url:'{{route('marketing.pendapatan.t_pmsn')}}',
      type:'GET',
      data: {
        tahun: tahun
      },
      success: function(data){
        $('#t_pmsn1').html(rupiah(data));
      },
      error: function(data){
        $('#t_pmsn1').html(0);
      }
  ...
  function totalBulan() {
    ...
    $.ajax({
      url:'{{route('marketing.pendapatan.total_harga_bulan')}}',
      type:'GET',
      data: {
        tahun: tahun,
        bulan: bulan
  ...
  $('.table_pmsn').DataTable({
    ...
    ajax: {
        url: '{{ route('marketing.pendapatan.get_data_pmsn') }}',
        type: 'GET',
        data: function(d) {
            d.tahun = $('#tahun').val();
            d.bulan = $('#bulan').val();
  ...
  $('#tahun, #bulan').on('change', function() {
    $('.table_pmsn').DataTable().ajax.reload();
    showcart()
    showcart2()
    totalTahun()
    totalBulan()
  ...
  function showcart() {
    ...
    $.ajax({
      url: '{{ route("marketing.pendapatan.get_data_tahun") }}',
      type: 'GET',
      data: {
          tahun: tahun,
      },
  ...
  function showcart2() {
    ...
    $.ajax({
      url: '{{ route("marketing.pendapatan.get_data_bulan") }}',
      type: 'GET',
      data: {
          tahun: tahun,
          bulan: bulan
